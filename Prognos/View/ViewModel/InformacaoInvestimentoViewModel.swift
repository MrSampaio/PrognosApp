...
class InformacaoInvestimentoViewModel: ObservableObject {
    ...
    public static let listaInvestimentos = [
            ...
            InformacaoInvestimentoModel(
                titulo: "Debênture Comum (Prefixada)",
